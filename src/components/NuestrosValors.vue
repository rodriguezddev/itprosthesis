<template>
    <div data-aos="zoom-out-up" class="contValores" style="">
        <h2 class="nuestros col-md-6 col-7 p-0 text-right" style=" font-family: 'Kollektif';">NUESTROS VALORES</h2>
        <div class="row  contEmpoderamosTextoValores justify-content-center  p-4 d-none d-md-flex d-lg-flex">
            <div class="col-md-5 col-lg-3  row flex-column align-items-center m-0 pl-4 pr-4 " style="padding: 2rem 1rem;" @mouseover="agU()" @mouseout="quite()" :class=" [showU ? 'colorU' : '']">
                <div class="borderCIr row justify-content-center align-items-center">
                    <div class="denC colorUno row justify-content-center align-items-center">
                        <svg class="icono-tas" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 211 211"><defs></defs><g id="Capa_2" data-name="Capa 2"><g id="Capa_4" data-name="Capa 4"><polyline class="check" points="51.96 113.05 95.47 148 170 57.94"/><circle class="check" cx="105.5" cy="105.5" r="103"/></g></g></svg>
                    </div>
                </div>
                <div class="row flex-column align-items-center m-0">
                    <div class=" bordeEtiquU mt-4 mb-4">
                        <h4 class="text-center colorUno p-2 m-1">ACCESIBILIDAD</h4>
                    </div>
                    <p class="textoVal d-none d-md-block">Todas nuestras propuestas son formuladas con el fin de que todos puedan acceder a nivel económico, social y cultural.</p>
                </div>
            </div>
            <div class="col-md-5 col-lg-3  row flex-column align-items-center m-0 pl-4 pr-4 " style="padding: 2rem 1rem;" @mouseover="agD()" @mouseout="quite()" :class=" [showD ? 'colorD' :  '' ]">
                <div class="borderCIr row justify-content-center align-items-center">
                    <div class="denC colorDos row m-0 justify-content-center align-items-center">
                        <div class="border-interno">
                            <svg  version="1.1" id="Capa_1" width="5rem" height="6rem" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
...
<style>
    .nuestros{
        font-size: 2.8rem;
        padding: 0;
        border-bottom: rgb(63, 63, 63) 3px solid;
        margin-bottom: 3rem;
    }
    ...
    .bordeEtiquU{
        border:1px #14B71C solid;
            width: 15rem;
    }
    .bordeEtiquD{
        border:1px #2359E5 solid;
            width: 15rem;
    }    
    .bordeEtiquT{
        border:1px #FF3A12 solid;
            width: 15rem;
    } 
    .bordeEtiquC{
        border:1px #f3e143 solid;
            width: 15rem;
    } 
    .check{
        fill:none;
...
@media only screen and (max-width: 1440px) and (min-width: 1205px){
}
@media only screen and (max-width: 1881px) and (min-width: 1441px){
}
@media only screen and (max-width: 2560px) and (min-width: 1880px){
}
